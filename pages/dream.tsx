        ...
        <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mb-0 mb-8">
          {status === "authenticated" ? (
            <Link
              ...
              <span className="font-semibold text-black">Click hier</span> om
              credits te kopen!
            </Link>
          ) : (
            <a
              ...
              <motion.div className="flex justify-between items-center w-full flex-col mt-4">
                {restoredImage && (
                  <div className="text-black">
                    Hier is jouw nieuw ontworpen{" "}
                    <b className="text-teal-600">{room.toLowerCase()} </b> in{" "}
                    <b className="text-teal-600">{theme.toLowerCase()}</b>{" "}
                    stijl!{" "}
                  </div>
                )}
                <div
                  ...
                  !originalPhoto && (
                    <div className="h-[250px] flex flex-col items-center space-y-6 max-w-[670px] -mt-8">
                      <div className="max-w-xl text-black">
                        Meld je aan voor een gratis account ontwerp jouw nieuwe
                        kamer vandaag nog. Je krijgt 1 gratis design.
                      </div>
