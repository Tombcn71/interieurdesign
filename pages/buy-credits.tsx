  ...
  return (
    <div className="bg-white">
      <div className="flex mx-auto max-w-7xl overflow-visible flex-col items-center justify-center py-2 min-h-screen">
        <Head>
          <title>Koop interieurdesign.ai credits</title>
        </Head>
        <Script
          className="bg-white"
        ...
        <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mb-0 mb-8">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              <p className="mt-2 text-4xl tracking-tight text-black sm:text-5xl">
                Koop interieurdesign.ai Credits
              </p>
            </div>
          </div>
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-500 mb-10">
            ...
            <span className="font-semibold text-gray-400">
              ...
              {data?.remainingGenerations > 1 ? "credits" : "credit"}. Koop
              hieronder jouw bundel veilg met ideal.
            </span>
          </p>
        </main>
        <div className="w-full">
          {session?.user?.email && (
            ...
            <stripe-pricing-table
              className="bg-white"
              pricing-table-id="prctbl_1NNJhoDsNyZivFnNZEq9aUr0"
              publishable-key="pk_live_51NJGRZDsNyZivFnN724icaIFUEVOmQ8uCm48HWLBRILD6QD7Wso0In3DAEKm82P9AKiY5ZHa5oQJkcYTkZf38fkt00hvXvmYBX"
        ...
        <div className="mt-10 text-center">
          <h4 className="flex-none leading-6 mt-2 text-2xl  tracking-tight text-black sm:text-5xl">
            Wat krijg je?
          </h4>
        </div>
        <ul
        ...
        <p className="text-gray-400 mb-5">
          ...
          <span className="text-gray-300">Tom@interieurdesign.ai</span>
        </p>
        <Footer />
      </div>
    </div>
